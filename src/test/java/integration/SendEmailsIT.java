...
public final class SendEmailsIT {
    ...
    public static void displayInfo() {
        ...
        logger.info("You need to run the project and launch the SMTP smtp on port {} before testing.", TestParams.IT_PORT);
    }

    @Test
    public void sendSimpleTestEmail() throws EmailException {
        Email email = new SimpleEmail();
        email.setHostName(TestParams.TEST_HOST);
        email.setSmtpPort(TestParams.IT_PORT);
    ...
    public void sendEmailWithAttachment() throws EmailException {
        ...
        attachment.setPath("src/main/resources" + Configuration.get("application.icon.path"));
